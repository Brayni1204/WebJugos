        ...
        <div class="card-body">
            <div class="container-fluid">
                <div class="form-container">
                    <h2 class="text-center mb-4">Crear Nueva Página</h2>
                    <form action="{{ route('admin.paginas.store') }}" method="POST" enctype="multipart/form-data">
                        @csrf
                        <div class="form-group">
                            <label>Título de la Página</label>
                            <input type="text" name="titulo_paginas" autocomplete="off" class="form-control"
                                value="{{ old('titulo_paginas') }}" required>
                        </div>
                        <div class="form-group">
                        ...
                        <div class="form-group">
                            <label>Resumen</label>
                            <textarea name="resumen" style="height: 350px" class="form-control">{{ old('resumen') }}</textarea>
                        </div>
                        <div class="form-group">
                        ...
                        <div class="d-flex" style="gap: 10px">
                            <button type="submit" class="btn btn-primary btn-custom"><i class="fas fa-save"></i>
                                Guardar</button>
                            <a href="{{ route('admin.paginas.index') }}" class="btn btn-custom"><i class="fas fa-times"></i>
                                🔙 Cancelar</a>
                        </div>
                        <div class="floating-btn-container">
                            <button type="submit" title="Guardar" class="btn btn-primary btn-custom"><i
