        ...
        <div class="card-body">
            <div class="container-fluid">
                <div class="form-container">
                    ...
                    <form id="categoriaForm" action="{{ route('admin.categoria.update', $categorium) }}" method="POST"
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" name="nombre_categoria" class="form-control"
                                value="{{ old('nombre_categoria', $categorium->nombre_categoria) }}" required>
                        </div>

                        <div class="form-group">
                            <label>Descripción</label>
                            <textarea name="descripcion" style="height: 280px" class="form-control">{{ old('descripcion', $categorium->descripcion) }}</textarea>
                        </div>

                        <div class="form-group">
                            <label>Estado</label>
                            <select name="status" class="form-control">
                                <option value="1" {{ $categorium->status == 1 ? 'selected' : '' }}>Activo</option>
                                <option value="2" {{ $categorium->status == 2 ? 'selected' : '' }}>Inactivo</option>
                            </select>
                        </div>
